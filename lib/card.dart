...
import 'package:flutter_credit_card/utilities/helper.dart';
          ...
          children: <Widget>[
            ...
            widget.frontLayout ??
                CardFrontLayout(
                        ...
                        cardWidth: cardWidth,
                        cardNumberFontSize: widget.cardNumberFontSize,
...
class FlutterCreditCard extends StatelessWidget {
  ...
  FlutterCreditCard({@required this.animation, @required this.child});
